...
var Outside = {
	...
	prepare: function(){
 	...
 	plan: function(){
 		Notifications.notify(Outside,_('{0} plans the trip. {0} packs a compass, some matches, some food and several bottles of coke into a travelling bag',Engine.x_name));
 		var plan = $('#planButton.button');
 		plan.hide();
